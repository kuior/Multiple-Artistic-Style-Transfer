...
if __name__ == '__main__':
		...
		style_image1 = load_image(STYLE_IMAGE1)
		style_image2 = load_image(STYLE_IMAGE2)
		# Load the model.
		...
		sess.run(model['input'].assign(style_image1))
		style_loss1 = style_loss_func(sess, model)
		
		sess.run(model['input'].assign(style_image2))
		style_loss2 = style_loss_func(sess, model)
		
		# Instantiate equation 7 of the paper.
		total_loss = BETA * content_loss + ALPHA * (style_loss1 + style_loss2)
